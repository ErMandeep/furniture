...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="EIKVBZ4v" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="YTx7LIs4VG" /></span>
    </div>
