...
$usernameErr = $passwordErr = $current_passwordErr = $new_passwordErr = $repeat_passwordErr = $edit_item_idErr = $item_nameErr = $item_categoryErr = $item_descriptionErr = $item_critical_lvlErr = $quantityErr = $uomErr = $received_by = $err = $verifyErr = "";
        ...
        while($row = $result->fetch_assoc()) {
                ...
                // && $row['status'] =='active')
            {
                ...
                $passwordErr = "<div class='alert alert-danger'>
                        <strong>Enter Password is Wrong </strong> Not Found.
                        </div>";
            }
        }
    } else{
        $usernameErr = "<div class='alert alert-danger'>
  <strong>This Username or Email </strong> Not Found.
</div>";
    }
}
