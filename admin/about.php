  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      if(isset($_POST['submit'])){
        ...
        $query1 = "UPDATE about SET description = '$descptn' WHERE id=1";
        ...
        $imagesql = "UPDATE about SET img = '$name1' WHERE id=1";
    ...
    <section class="content">
      ...
      <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <button type="submit" name="submit"  style="float: right;" class="btn btn-primary">Update</button>
